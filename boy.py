...
class Bird:
    ...
    def draw(self):
        if self.direction == 1:
            self.image.clip_composite_draw(int(self.frame) * 376, 376, 181, 188, 3.141592, 'hv', self.x, self.y, 50, 50)
        else:
            self.image.clip_composite_draw(int(self.frame) * 376, 376, 181, 188, 3.141592, 'v',self.x, self.y, 50, 50)
...
class Boy:
    ...
    def __init__(self):
        ...
        self.birds = [Bird(random.randint(0, 800), random.randint(200, 600), random.choice([-1, 1])) for _ in range(10)]
